...
interface MathInterface extends Remote{
    ...
    public int div (int a, int b) throws RemoeteException;
}

public class CalcSever extends unicastRemoteObject implements MathInterface{
    
    pubcli CalcServer() throws RemoteException{
        System.out.println("Server is Initializing..Wait..");
    }
    ...
    public static void main (String args[]){
        try {
            ...
            java.rmi.Naming.rebind("CalcServ", calc);
            System.out.println("Server is Ready");
            
        }
        catch(RemoteException e){
            System.out.println("Remote Server Error: " + e.getMessage());
            System.exit(0);
        }
        catch(MalformedURLException me){
            System.out.println("Invalidd URL");
        }
    }
}


// Now its time to prepare the client . We just finished the server.
...
public class CalcClient extends Frame Implements ActionListener{
